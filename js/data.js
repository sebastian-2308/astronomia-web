      ...
      modulos: [
        ...
        },
        {
          ...
          lecciones: [
            ...
            { titulo: 'Planetas Interiores', video: 'https://www.youtube.com/embed/vQIsQK4m7Qk', texto: 'Mercurio (diámetro 4,879 km, sin atmósfera, temperaturas de -180°C a 430°C), Venus (12,104 km, atmósfera de CO2, 462°C, gira al revés), Tierra (12,756 km, 71% agua, única con vida), Marte (6,792 km, atmósfera delgada, tiene el Monte Olimpo y Valles Marineris). Entre Marte y Júpiter está el cinturón de asteroides.' },
            { titulo: 'Planetas Exteriores', video: 'https://www.youtube.com/embed/vQIsQK4m7Qk', texto: 'Júpiter (142,984 km, el más grande, Gran Mancha Roja, 95 lunas), Saturno (120,536 km, famoso por anillos de hielo, 146 lunas), Urano (51,118 km, rota de lado, 27 lunas), Neptuno (49,528 km, vientos de 2,100 km/h, 16 lunas). Plutón fue reclasificado como planeta enano en 2006.' }
          ]
        },
        {
          ...
          lecciones: [
            ...
            { titulo: 'Clasificación Espectral Estelar', video: 'https://www.youtube.com/embed/dwsS8TNorhQ', texto: 'Las estrellas se clasifican por tipo espectral: O (azules, muy calientes >30,000K), B (azul-blancas), A (blancas), F (amarillo-blancas), G (amarillas como el Sol, 5,500K), K (naranjas) y M (rojas, más frías <3,500K). La regla mnemotécnica es: "Oh, Be A Fine Girl/Guy, Kiss Me". También se clasifican por luminosidad (I a V).' },
            { titulo: 'Ciclo de Vida Estelar', video: 'https://www.youtube.com/embed/dwsS8TNorhQ', texto: 'Las estrellas nacen en nebulosas. Su evolución depende de la masa inicial: estrellas como el Sol se convierten en gigantes rojas y terminan como enanas blancas. Estrellas masivas (>8 masas solares) explotan como supernovas, dejando estrellas de neutrones o agujeros negros. Las estrellas más masivas pueden formar agujeros negros.' }
          ]
        },
        {
        ...
        },
        {
          ...
          lecciones: [
            ...
            { titulo: 'Segunda Ley de Kepler', video: 'https://www.youtube.com/embed/uDG0sibnPQo', texto: 'La segunda ley (Ley de las Áreas) dice que el radio vector que une un planeta con el Sol barre áreas iguales en tiempos iguales. Esto significa que los planetas se mueven más rápido cuando están cerca del Sol (perihelio) y más lento cuando están lejos (afelio). La Tierra está en perihelio en enero (147 millones km) y afelio en julio (152 millones km).' },
            { titulo: 'Tercera Ley de Kepler', video: 'https://www.youtube.com/embed/uDG0sibnPQo', texto: 'La tercera ley relaciona el periodo orbital (T) con la distancia media al Sol (a): T² = a³ (cuando T está en años terrestres y a en UA). Por ejemplo, Marte está a 1.52 UA, entonces T² = 1.52³, T = 1.88 años (687 días). Esta ley permitió calcular distancias en el Sistema Solar por primera vez.' },
            { titulo: 'Aplicaciones de las Leyes de Kepler', video: 'https://www.youtube.com/embed/uDG0sibnPQo', texto: 'Las leyes de Kepler son fundamentales para: calcular órbitas de satélites artificiales, determinar masas de estrellas binarias, descubrir exoplanetas (método de velocidad radial), planificar misiones espaciales y entender la dinámica del Sistema Solar. Newton demostró que estas leyes derivan de la ley de gravitación universal.' }
          ]
        }
      ]
    },
