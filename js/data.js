      ...
      modulos: [
        {
          ...
          lecciones: [
            { titulo: 'Tipos de Telescopios', video: 'https://www.youtube-nocookie.com/embed/mNSzwN3BU14', texto: 'Los telescopios son instrumentos diseñados para observar objetos lejanos mediante la captación de radiación electromagnética. Existen tres tipos principales: refractores (usan lentes), reflectores (usan espejos) y catadióptricos (combinación de ambos). Cada tipo tiene ventajas según el uso: los refractores son ideales para observación lunar y planetaria, mientras que los reflectores destacan en la observación de objetos de cielo profundo como nebulosas y galaxias.' },
            { titulo: 'Partes y Funcionamiento', video: 'https://www.youtube-nocookie.com/embed/mNSzwN3BU14', texto: 'Un telescopio se compone de: objetivo (lente o espejo principal que capta la luz), ocular (amplía la imagen formada por el objetivo), buscador (pequeño telescopio de bajo aumento para localizar objetos), montura (soporte que permite el movimiento) y trípode. La montura puede ser altacimutal (movimiento vertical y horizontal) o ecuatorial (alineada con el eje terrestre para seguir estrellas).' },
            { titulo: 'Instrumentos de Medición Astronómica', video: 'https://www.youtube-nocookie.com/embed/mNSzwN3BU14', texto: 'Además de los telescopios ópticos, los astrónomos usan: radiotelescopios (captan ondas de radio), espectrógrafos (descomponen la luz para analizar composición química), fotómetros (miden brillo), CCDs (cámaras digitales de alta sensibilidad) y coronógrafos (bloquean la luz estelar para observar objetos débiles cercanos).' }
          ]
        },
        {
          titulo: 'Medidas de Posicionamiento',
          lecciones: [
            { titulo: 'Coordenadas Terrestres', video: 'https://www.youtube-nocookie.com/embed/soQ5MN0nuMg', texto: 'Para ubicarnos en la Tierra usamos latitud (distancia angular al ecuador) y longitud (distancia angular al meridiano de Greenwich). La latitud es fundamental en astronomía: desde el ecuador se ven ambas esferas celestes, desde los polos solo una. El observador en Caracas (10.5°N) tiene una perspectiva privilegiada del cielo.' },
            { titulo: 'Coordenadas Celestes', video: 'https://www.youtube-nocookie.com/embed/soQ5MN0nuMg', texto: 'Para ubicar estrellas usamos: ascensión recta (equivalente a longitud terrestre, medida en horas, minutos y segundos) y declinación (equivalente a latitud). También existe el sistema horizontal con azimut y altura. El movimiento aparente de las estrellas se debe a la rotación terrestre: 15° por hora hacia el oeste.' },
            { titulo: 'Movimiento Aparente del Cielo', video: 'https://www.youtube-nocookie.com/embed/soQ5MN0nuMg', texto: 'La esfera celeste parece girar de este a oeste debido a la rotación terrestre. Las estrellas circumpolares nunca se ocultan cerca de los polos. El Sol sigue la eclíptica, inclinada 23.5° respecto al ecuador celeste, causando las estaciones. La precesión de los equinoccios cambia lentamente la orientación del eje terrestre cada 26,000 años.' }
          ]
        },
        {
          titulo: 'Constelaciones',
          lecciones: [
            { titulo: 'Historia y Origen de las Constelaciones', video: 'https://www.youtube-nocookie.com/embed/w2b9JShncUM', texto: 'Las constelaciones son agrupaciones aparentes de estrellas que forman figuras imaginarias. Fueron nombradas por civilizaciones antiguas: griegos, romanos, babilonios y árabes. La Unión Astronómica Internacional reconoce oficialmente 88 constelaciones que cubren toda la esfera celeste. Cada una tiene límites precisos.' },
            { titulo: 'Constelaciones del Hemisferio Norte', video: 'https://www.youtube-nocookie.com/embed/w2b9JShncUM', texto: 'Las más conocidas son: Osa Mayor (con el Carro, apunta a la Estrella Polar), Osa Menor (contiene la Estrella Polar), Casiopea (forma de W), Orión (visible en invierno, con Betelgeuse y Rigel), Leo, Virgo y Escorpión. La Estrella Polar marca el norte y parece fija en el cielo.' },
            { titulo: 'Constelaciones del Hemisferio Sur', video: 'https://www.youtube-nocookie.com/embed/w2b9JShncUM', texto: 'Desde Venezuela también vemos constelaciones australes como: Cruz del Sur (la más famosa, aparece en banderas de Australia y Brasil), Centauro (con Alfa Centauri, la estrella más cercana), Carina (con Canopus, la segunda más brillante) y Escorpión (visible en las noches de invierno).' }
          ]
        },
        {
          titulo: 'La Tierra y la Luna',
          lecciones: [
            { titulo: 'La Tierra: Nuestro Planeta', video: 'https://www.youtube-nocookie.com/embed/soQ5MN0nuMg', texto: 'La Tierra es el tercer planeta del Sistema Solar, con un diámetro de 12,756 km. Tiene una atmósfera rica en nitrógeno y oxígeno que protege la vida. Su campo magnético nos protege del viento solar. El 71% de su superficie está cubierta por agua. Es el único planeta conocido con vida. Su rotación dura 24 horas y su traslación 365.25 días.' },
            { titulo: 'La Luna: Nuestro Satélite Natural', video: 'https://www.youtube-nocookie.com/embed/xd1a0BHZ2uo', texto: 'La Luna tiene un diámetro de 3,474 km y está a 384,400 km de distancia. Su superficie tiene mares (planicies de lava solidificada), cráteres de impacto y montañas. No tiene atmósfera ni agua líquida. La cara oculta de la Luna fue fotografiada por primera vez en 1959 por la sonda soviética Luna 3.' },
            { titulo: 'Fases Lunares y Eclipses', video: 'https://www.youtube-nocookie.com/embed/MjJxaCBjUQ4', texto: 'Las fases lunares son: Luna Nueva, Cuarto Creciente, Luna Llena y Cuarto Menguante. El ciclo completo dura 29.5 días. Los eclipses lunares ocurren cuando la Tierra se interpone entre el Sol y la Luna. Los eclipses solares ocurren cuando la Luna se interpone entre el Sol y la Tierra. En 2026 hay un eclipse total de Luna (14 marzo).' }
          ]
        },
        {
          titulo: 'El Sistema Solar',
          lecciones: [
            { titulo: 'Estructura del Sistema Solar', video: 'https://www.youtube-nocookie.com/embed/vQIsQK4m7Qk', texto: 'El Sistema Solar está formado por el Sol y todos los cuerpos que orbitan a su alrededor: 8 planetas, 5 planetas enanos, cientos de lunas, millones de asteroides y billones de cometas. Se divide en sistema solar interior (planetas rocosos) y exterior (gigantes gaseosos). El límite gravitacional del Sol alcanza la Nube de Oort, a 1 año luz.' },
            { titulo: 'Planetas Interiores', video: 'https://www.youtube-nocookie.com/embed/vQIsQK4m7Qk', texto: 'Mercurio (diámetro 4,879 km, sin atmósfera, temperaturas de -180°C a 430°C), Venus (12,104 km, atmósfera de CO2, 462°C, gira al revés), Tierra (12,756 km, 71% agua, única con vida), Marte (6,792 km, atmósfera delgada, tiene el Monte Olimpo y Valles Marineris). Entre Marte y Júpiter está el cinturón de asteroides.' },
            { titulo: 'Planetas Exteriores', video: 'https://www.youtube-nocookie.com/embed/vQIsQK4m7Qk', texto: 'Júpiter (142,984 km, el más grande, Gran Mancha Roja, 95 lunas), Saturno (120,536 km, famoso por anillos de hielo, 146 lunas), Urano (51,118 km, rota de lado, 27 lunas), Neptuno (49,528 km, vientos de 2,100 km/h, 16 lunas). Plutón fue reclasificado como planeta enano en 2006.' }
          ]
        },
        {
          titulo: 'El Sol, las Estrellas y su Clasificación',
          lecciones: [
            { titulo: 'El Sol: Nuestra Estrella', video: 'https://www.youtube-nocookie.com/embed/dwsS8TNorhQ', texto: 'El Sol es una estrella de tipo espectral G2V, de color amarillo-blanca. Contiene el 99.86% de toda la masa del sistema solar. Su núcleo alcanza 15 millones de grados Celsius, donde ocurre la fusión nuclear de hidrógeno en helio. Su energía tarda 8 minutos en llegar a la Tierra. Tiene un diámetro de 1,391,000 km.' },
            { titulo: 'Clasificación Espectral Estelar', video: 'https://www.youtube-nocookie.com/embed/dwsS8TNorhQ', texto: 'Las estrellas se clasifican por tipo espectral: O (azules, muy calientes >30,000K), B (azul-blancas), A (blancas), F (amarillo-blancas), G (amarillas como el Sol, 5,500K), K (naranjas) y M (rojas, más frías <3,500K). La regla mnemotécnica es: "Oh, Be A Fine Girl/Guy, Kiss Me". También se clasifican por luminosidad (I a V).' },
            { titulo: 'Ciclo de Vida Estelar', video: 'https://www.youtube-nocookie.com/embed/dwsS8TNorhQ', texto: 'Las estrellas nacen en nebulosas. Su evolución depende de la masa inicial: estrellas como el Sol se convierten en gigantes rojas y terminan como enanas blancas. Estrellas masivas (>8 masas solares) explotan como supernovas, dejando estrellas de neutrones o agujeros negros. Las estrellas más masivas pueden formar agujeros negros.' }
          ]
        },
        {
          titulo: 'Nebulosas y Galaxias',
          lecciones: [
            { titulo: 'Nebulosas: Viveros Estelares', video: 'https://www.youtube-nocookie.com/embed/8oyPWLVv3_4', texto: 'Las nebulosas son nubes de gas y polvo interestelar. Pueden ser: de emisión (brillan por radiación ultravioleta de estrellas cercanas, como la Nebulosa de Orión), de reflexión (reflejan luz estelar, azuladas), oscuras (bloquean la luz, como la Cabeza de Caballo) y planetarias (restos de estrellas como el Sol).' },
            { titulo: 'Tipos de Galaxias', video: 'https://www.youtube-nocookie.com/embed/8oyPWLVv3_4', texto: 'Las galaxias se clasifican en: espirales (como la Vía Láctea, con brazos curvos), elípticas (como M87, sin estructura definida), espirales barradas (como la Vía Láctea, con una barra central) e irregulares (como las Nubes de Magallanes). La Vía Láctea tiene entre 100 y 400 mil millones de estrellas.' },
            { titulo: 'La Vía Láctea y Andrómeda', video: 'https://www.youtube-nocookie.com/embed/8oyPWLVv3_4', texto: 'La Vía Láctea es una galaxia espiral barrada con un diámetro de 100,000 años luz. Nuestro Sistema Solar orbita su centro a 250 km/s, completando una vuelta cada 230 millones de años. Andrómeda (M31), nuestra galaxia vecina, está a 2.5 millones de años luz. Colisionará con la Vía Láctea en unos 4.5 mil millones de años.' }
          ]
        },
        {
          titulo: 'Teorías del Origen del Universo',
          lecciones: [
            { titulo: 'El Big Bang', video: 'https://www.youtube-nocookie.com/embed/8oyPWLVv3_4', texto: 'La teoría del Big Bang propone que el universo comenzó hace 13,800 millones de años a partir de un estado infinitamente denso y caliente. Georges Lemaître propuso la idea en 1927. Edwin Hubble confirmó la expansión en 1929. La radiación de fondo de microondas (CMB), descubierta en 1965, es la prueba más sólida de esta teoría.' },
            { titulo: 'Evolución del Universo Temprano', video: 'https://www.youtube-nocookie.com/embed/8oyPWLVv3_4', texto: 'En los primeros 3 minutos se formaron protones y neutrones. A los 380,000 años, el universo se enfrió lo suficiente para formar átomos neutros (recombinación), liberando la radiación CMB. Luego vinieron las "edades oscuras" hasta que las primeras estrellas y galaxias se formaron unos 400 millones de años después del Big Bang.' },
            { titulo: 'El Futuro del Universo', video: 'https://www.youtube-nocookie.com/embed/8oyPWLVv3_4', texto: 'Hay tres escenarios posibles: Big Crunch (el universo deja de expandirse y colapsa), Big Freeze (expansión eterna, todo se enfría) y Big Rip (expansión acelerada desgarra todo). Las observaciones actuales favorecen el Big Freeze, con la energía oscura acelerando la expansión.' }
          ]
        },
        {
          titulo: 'Introducción a la Astrofísica: Leyes de Kepler',
          lecciones: [
            { titulo: 'Primera Ley de Kepler', video: 'https://www.youtube-nocookie.com/embed/uDG0sibnPQo', texto: 'La primera ley de Kepler (1609) establece que los planetas orbitan al Sol en órbitas elípticas, con el Sol en uno de los focos. Una elipse tiene dos focos; el Sol ocupa uno. La excentricidad mide qué tan alargada es la órbita: la Tierra tiene excentricidad 0.017 (casi circular), mientras que Mercurio tiene 0.205 (más elíptica).' },
            { titulo: 'Segunda Ley de Kepler', video: 'https://www.youtube-nocookie.com/embed/uDG0sibnPQo', texto: 'La segunda ley (Ley de las Áreas) dice que el radio vector que une un planeta con el Sol barre áreas iguales en tiempos iguales. Esto significa que los planetas se mueven más rápido cuando están cerca del Sol (perihelio) y más lento cuando están lejos (afelio). La Tierra está en perihelio en enero (147 millones km) y afelio en julio (152 millones km).' },
            { titulo: 'Tercera Ley de Kepler', video: 'https://www.youtube-nocookie.com/embed/uDG0sibnPQo', texto: 'La tercera ley relaciona el periodo orbital (T) con la distancia media al Sol (a): T² = a³ (cuando T está en años terrestres y a en UA). Por ejemplo, Marte está a 1.52 UA, entonces T² = 1.52³, T = 1.88 años (687 días). Esta ley permitió calcular distancias en el Sistema Solar por primera vez.' },
            { titulo: 'Aplicaciones de las Leyes de Kepler', video: 'https://www.youtube-nocookie.com/embed/uDG0sibnPQo', texto: 'Las leyes de Kepler son fundamentales para: calcular órbitas de satélites artificiales, determinar masas de estrellas binarias, descubrir exoplanetas (método de velocidad radial), planificar misiones espaciales y entender la dinámica del Sistema Solar. Newton demostró que estas leyes derivan de la ley de gravitación universal.' }
          ]
        }
      ]
    },
